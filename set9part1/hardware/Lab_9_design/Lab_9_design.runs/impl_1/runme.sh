...
HD_PWD='C:/ECE520/Lab9/Lab_9_design/Lab_9_design.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab9_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab9_design_1_wrapper.tcl -notrace
