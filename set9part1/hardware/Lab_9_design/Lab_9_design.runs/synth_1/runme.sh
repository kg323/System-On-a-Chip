...
HD_PWD='C:/ECE520/Lab9/Lab_9_design/Lab_9_design.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab9_design_1_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab9_design_1_wrapper.tcl
