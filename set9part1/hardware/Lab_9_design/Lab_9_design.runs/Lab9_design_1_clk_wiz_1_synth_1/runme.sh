...
HD_PWD='C:/ECE520/Lab9/Lab_9_design/Lab_9_design.runs/Lab9_design_1_clk_wiz_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab9_design_1_clk_wiz_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab9_design_1_clk_wiz_1.tcl
