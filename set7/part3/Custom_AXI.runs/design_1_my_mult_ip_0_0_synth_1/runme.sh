...
HD_PWD='C:/ECE520/Lab7/Part3/Custom_AXI.runs/design_1_my_mult_ip_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_my_mult_ip_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_my_mult_ip_0_0.tcl
